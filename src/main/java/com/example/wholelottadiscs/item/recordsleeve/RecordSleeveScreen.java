...
public class RecordSleeveScreen extends AbstractContainerScreen<RecordSleeveContainer> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(WholeLottaDiscs.MOD_ID,"textures/gui/record_sleeve.png");
    public RecordSleeveScreen(RecordSleeveContainer pMenu, Inventory playerInv, Component title) {
